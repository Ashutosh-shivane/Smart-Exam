...
urlpatterns = [
    ...
    path('admin-shedule-course', views.admin_shedule_course_view,name='admin-shedule-course'),
    path('admin-report', views.admin_report_view,name='admin-report'),



path('admin-report-month-student', views.generate_monthly_student_report,name='admin-report-month-student'),
path('admin-report-all-student', views.generate_all_student_report,name='admin-report-all-student'),
path('admin-report-month-teacher', views.monthly_teacher_report,name='admin-report-month-teacher'),
path('admin-report-all-teacher', views.all_teachers_report,name='admin-report-all-teacher'),
path('admin-report-student-info', views.generate_student_report,name='admin-report-student-info'),
path('admin-report-exam-info', views.generate_all_exam_report,name='admin-report-exam-info'),

path('generate-report/', views.generate_report_dispatcher, name='generate-report'),
