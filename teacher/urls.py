...
# new code
path('teacher/select-course/', views.teacher_select_course_view, name='teacher_select_course'),
path('teacher/add-question/', views.teacher_add_question_view_test, name='teacher_add_question'),
